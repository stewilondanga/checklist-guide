    ...
    if ($(this).closest('[class*="list-"]').is('.list-standard')) {
      if ($(this).is(':checked')) {
        ...
        if ($(this).is('[type="checkbox"]')) {
          ...
          $(this).siblings('[data-icon]').attr('data-icon', 'dot-circle').closest('.checkbox').siblings('.checkbox').removeClass('checked').children('[type="radio"]').prop('checked', false).siblings('[data-icon]').attr({
            'data-icon': 'circle',
            'data-prefix': 'far'
          });
        }
